...
def score(nice,mean,name):
    # score function is being passed to values stored within the 3 variables
...
def win(nice,mean,name):
    # Subsitute the {} wildcards with our variables values
...
def reset(nice,mean,name):
    nice = 0
    mean = 0
    #Notice, I do not reset the name variable as that smae user has elected to play again
